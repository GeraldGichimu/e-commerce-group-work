...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO flights (airline, flight_number, departure_city, arrival_city, departure_date, arrival_date, price, seats_available, image_path) 
                               VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$airline, $flight_number, $departure_city, $arrival_city, $departure_date, $arrival_date, $price, $seats_available, $image_path]);
...
<head>
    ...
    <title>Add New Flight | TravelEase Admin</title>
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="image" class="form-label">Flight Image (Airline Logo or Aircraft)</label>
